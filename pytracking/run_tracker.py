...
from pytracking.evaluation.oloddataset import OLODDataset
...
def main():
    ...
    parser.add_argument('--tracker_param', type=str, default='default_params', help='Name of parameter file.')
    parser.add_argument('--runid', type=int, default=None, help='The run id.')
    parser.add_argument('--dataset', type=str, default='olod', help='Name of dataset (otb, nfs, uav, tpl, vot, tn, gott, gotv, lasot).')
